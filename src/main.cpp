...
// Test - Bahari
uint32_t prevNodeInfoMillis;
uint32_t currNodeInfoMillis;
PhoneAPI *bluetoothNodeInfoPhoneAPI;
...
// Prepare for button presses
  ...
  protected:
    ...
    int32_t runOnce()
    {
        ...
        // Date: 08/12/2021
        // Remarks: Keep the device in wake up mode
        if (currMillis - prevMillis > 60 * 1000){
            DEBUG_MSG("Status: WAKE UP\n");
...
void loop()
{
    ...
    // Test - Bahari
    currNodeInfoMillis = millis();
    if (currNodeInfoMillis - prevNodeInfoMillis > 60 * 1000){
            //DEBUG_MSG("Status: Send NodeInfo\n");
        
            //bluetoothNodeInfoPhoneAPI -> getFromRadioApp();
            //bluetoothNodeInfoPhoneAPI -> handleToRadioApp();
            //bluetoothNodeInfoPhoneAPI -> getFromRadioApp();
            prevNodeInfoMillis = currNodeInfoMillis; 
    }
}
